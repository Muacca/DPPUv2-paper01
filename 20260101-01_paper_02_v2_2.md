...
- Riemann テンソル（第3・4添字で反対称）： $R^{a}{}\_{bcd} = \partial\_c \Gamma^{a}{}\_{bd} - \partial\_d \Gamma^{a}{}\_{bc} + \Gamma^{a}{}\_{ec}\Gamma^{e}{}\_{bd} - \Gamma^{a}{}\_{ed}\Gamma^{e}{}\_{bc}$
...
ここで：
- $N_{\mathrm{TT}}$：torsion-torsion 項。 $\frac{1}{4}\varepsilon^{abcd} T^{e}{}\_{ab} T\_{ecd}$ の形をとる。
...
|-----------|---------|-----------------------------------|
| $S^3$（SU(2)） | $C^{i}{}\_{jk} = \frac{4}{r} \varepsilon\_{ijk}$ | $+24/r^2$ （正曲率） |
