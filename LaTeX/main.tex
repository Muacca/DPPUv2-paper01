...
\input{sections/sec2}  % Setup and conventions
\input{sections/sec3}  % Topology-specific reductions
\input{sections/sec4}  % Numerical results
\input{sections/sec5}  % Mechanisms and interpretation
\input{sections/sec6}  % Representative points and stability quality
\input{sections/sec7}  % Interpretation and utility
\input{sections/sec8}  % Conclusions and outlook
...
%------------------------------------------------------------------------------
\appendix
\input{appendices/appA}  % Theoretical details
\input{appendices/appB}  % Reproducibility and verification
\input{appendices/appC}  % Numerical computation details
\input{appendices/appD}  % Visualization tools
\input{appendices/appE}  % Volume rescaling invariance in T3×S1
\input{appendices/appF}  % Code and data access
\input{appendices/appG}  % Errata and revision history (v1 → v2)
