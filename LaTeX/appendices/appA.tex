...
\toprule
 & FULL & TT & REE \\
\midrule
$\Sthree$ & $6V\eta\theta_{\NY}$ & $12V\eta\theta_{\NY}$ & $6V\eta\theta_{\NY}$ \\
$\Tthree$ & $6V\eta\theta_{\NY}$ & $12V\eta\theta_{\NY}$ & $6V\eta\theta_{\NY}$ \\
$\Nilthree$ & $24V\eta\theta_{\NY}$ & $48V\eta\theta_{\NY}$ & $24V\eta\theta_{\NY}$ \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
$\Sthree$ & $9\eta^2 - 36$ & $\eta = -2, +2$ \\
$\Tthree$ & $9\eta^2$ & $\eta = 0$ \\
$\Nilthree$ & $36\eta^2 + 3$ & None (always positive) \\
\bottomrule
\end{tabular}
\end{table}
...
For $\Sthree$: $C = 0$ at $\eta = -2, +2$ (I/II boundaries).
