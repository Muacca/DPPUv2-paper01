...
$\eta$ & $-10.0$ & 5.0 & 151 & 0.1 (linear) \\
$\theta_{\NY}$ & 0.0 & 5.0 & 51 & 0.1 (linear) \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[htbp]
\centering
  \includegraphics[width=0.8\textwidth]{figures/Fig20_Type_classification_flowchart.png}
...
\begin{center}
\texttt{dppu\_scan\_<topology>\_<variant>\_<mode>\_<timestamp>.csv}
\end{center}

Example: \texttt{dppu\_scan\_S3S1\_FULL\_MX\_20260211\_091303csv}
