...
\ref{fig:phase_matrix_04to05} & \texttt{fig12\_phase\_matrix\_04to05.png} & Phase matrix ($\theta_{\NY}=0.4, 0.5$) \\
\ref{fig:phase_matrix_08to09} & \texttt{fig13\_phase\_matrix\_08to09.png} & Phase matrix ($\theta_{\NY}=0.8, 0.9$) \\
\ref{fig:phase_potential_S3} & \texttt{fig14\_Phase\_Potential\_S3.png} & $\Sthree$ phase-potential \\
\ref{fig:phase_potential_T3} & \texttt{fig15\_Phase\_Potential\_T3.png} & $\Tthree$ phase-potential \\
\ref{fig:phase_potential_Nil3} & \texttt{fig16\_Phase\_Potential\_Nil3.png} & $\Nilthree$ phase-potential \\
\ref{fig:scaling_laws_S3} & \texttt{fig17\_Scaling\_laws\_S3.png} & $\Sthree$ scaling laws \\
\ref{fig:scaling_laws_T3} & \texttt{fig18\_Scaling\_laws\_T3.png} & $\Tthree$ scaling laws \\
\ref{fig:scaling_laws_Nil3} & \texttt{fig19\_Scaling\_laws\_Nil3.png} & $\Nilthree$ scaling laws \\
\bottomrule
\end{tabular}
\end{table}
